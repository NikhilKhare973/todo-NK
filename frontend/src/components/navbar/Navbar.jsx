...
const Navbar = () => {
  ...
  <div className="container">
    <Link className="navbar-brand" id='todo-color' to="/"><b><GiWhiteBook /> &nbsp;TODO</b></Link>
      ...
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
       ...
       {isLoggedIn && (
        ...
        <div className='d-flex my-lg-0 my-3' >
          ...
          <div>
              <li className="nav-item d-flex-center">
                  <Link className="nav-link active" aria-current="page" to="/">
                    <img
                        className='img-fluid user-png' 
                        src='https://img.icons8.com/?size=100&id=492ILERveW8G&format=png&color=000000' alt='/' /></Link>
            </li>
          </div>
